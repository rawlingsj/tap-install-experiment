These are experimental docs that make up a proof of concept to enable a GitOps approach for installing and upgrading [Tanzu Community Edition](https://tanzucommunityedition.io/).
